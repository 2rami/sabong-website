...
const BodyWash = () => {
  ...
  const images = [
    ...
    "/images/bodywash/2.png",
    "/images/bodywash/3.png",
    "/images/bodywash/4.png"
  ]
          ...
          <div ref={contentRef} className="self-start mt-[100px]">
            <div className="max-w-lg">
              <div className="text-center mb-8">
                <div className="staggered-line">
                  <p className="font-pretendard text-lg text-stone-100 leading-relaxed staggered-text"><span className="font-bold">사봉 바디 워시</span>는</p>
                </div>
                <div className="staggered-line">
                  <p className="font-pretendard text-lg text-stone-100 leading-relaxed staggered-text">피부에 <span className="font-bold">부드럽게</span> 작용하는</p>
                </div>
                <div className="staggered-line">
              ...
              <div className="text-center">
                <div className="staggered-line">
                  <p className="font-pretendard text-base text-stone-200 leading-relaxed staggered-text"><span className="font-bold">풍성한 거품</span>과 함께 <span className="font-bold">은은한 향기</span>가</p>
                </div>
                <div className="staggered-line">
                  <p className="font-pretendard text-base text-stone-200 leading-relaxed staggered-text">하루의 <span className="font-bold">피로를 씻어냅니다</span></p>
                </div>
                <div className="mt-4">
                  <div className="staggered-line">
